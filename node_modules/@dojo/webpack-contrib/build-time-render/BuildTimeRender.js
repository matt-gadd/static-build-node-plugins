        ...
        compiler.hooks.afterEmit.tapAsync(this.constructor.name, (compilation, callback) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
				...
				yield page.exposeFunction('__communicator', async (modulePath, args) => {
					...
					let ex = fs_extra_1.readFileSync(path_1.join(this._output, 'src', `${modulePath}.js`), 'utf-8');
					ex = ex.replace('/** INSERT_CACHE **/', `__CACHE__['${JSON.stringify(args)}'] = ${JSON.stringify(res)};\n/** INSERT_CACHE **/`);
					fs_extra_1.writeFileSync(path_1.join(this._output, 'src', `${modulePath}.js`), ex, 'utf-8');
