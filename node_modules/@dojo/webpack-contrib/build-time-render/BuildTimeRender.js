            ...
            try {
				...
				yield page.exposeFunction('__communicator', async (modulePath, args) => {
					...
					if (res && typeof res.then === 'function') {
						...
						node.prepend(`window.__cache=window.__cache||{};window.__cache['${modulePath}']=window.__cache['${modulePath}']||{};window.__cache['${modulePath}']['${JSON.stringify(args)}'] = { async: true, value: ${JSON.stringify(asyncRes)} };\n`)
