 ...
 */
    ...
    add('object-assign', typeof global_1.default.Object.assign === 'function', true);
    add('arraybuffer', typeof global_1.default.ArrayBuffer !== 'undefined', true);
    add('formdata', typeof global_1.default.FormData !== 'undefined', true);
    add('filereader', typeof global_1.default.FileReader !== 'undefined', true);
    add('xhr', typeof global_1.default.XMLHttpRequest !== 'undefined', true);
    add('xhr2', has('xhr') && 'responseType' in global_1.default.XMLHttpRequest.prototype, true);
    add('blob', function () {
        if (!has('xhr2')) {
            return false;
        }
    ...
    add('node-buffer', 'Buffer' in global_1.default && typeof global_1.default.Buffer === 'function', true);
    add('fetch', 'fetch' in global_1.default && typeof global_1.default.fetch === 'function', true);
    add('web-worker-xhr-upload', typeof global_1.default.Promise !== 'undefined' &&
